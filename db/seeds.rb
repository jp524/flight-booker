...
Flight.create!(
  [{
    ...
    departure_time: DateTime.new(2022, 12, 21, 15, 45, 0, '-08:00'),
    duration: 745
  }, {
    number: 'CA1835',
    ...
    departure_time: DateTime.new(2022, 12, 22, 8, 0, 0, '+06:00'),
    duration: 135
  }, {
    number: 'AF659',
    ...
    departure_time: DateTime.new(2022, 12, 23, 11, 10, 0, '+04:00'),
    duration: 455
  }, {
    number: 'BA294',
    ...
    departure_time: DateTime.new(2022, 12, 24, 17, 0, 0, '-06:00'),
    duration: 460
  }, {
    number: 'NK1025',
    ...
    departure_time: DateTime.new(2022, 12, 25, 18, 30, 0, '-06:00'),
    duration: 127
  }, {
    number: 'NH126',
    ...
    departure_time: DateTime.new(2022, 12, 26, 21, 5, 0, '+09:00'),
    duration: 600
  }, {
    number: 'CA1884',
    departure_airport_id: 8, arrival_airport_id: 2,
    departure_date: Date.new(2022, 12, 26),
    departure_time: DateTime.new(2022, 12, 26, 16, 15, 0, '+08:00'),
    duration: 145
  }, {
    number: 'AF662',
    departure_airport_id: 9,
    arrival_airport_id: 4, departure_date: Date.new(2022, 12, 27),
    departure_time: DateTime.new(2022, 12, 27, 13, 35, 0, '+01:00'),
    duration: 705
  }, {
    number: 'BA295',
    ...
    departure_time: DateTime.new(2022, 12, 28, 11, 20, 0, '+00:00'),
    duration: 535
  }]
)

Booking.create!([{ flight_id: 1 }, { flight_id: 4 }])
